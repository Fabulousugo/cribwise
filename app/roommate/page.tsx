        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-accent text-primary-foreground px-6 py-3 rounded-full font-bold text-sm shadow-lg">
              ...
              <p className="text-xl md:text-2xl text-slate-700 dark:text-muted-foreground leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/roommate/browse">
                  <Button 
                    size="lg" 
                    className="bg-gradient-to-r from-primary to-accent hover:from-purple-700 hover:to-pink-700 text-primary-foreground font-bold rounded-2xl px-8 py-6 text-lg shadow-xl hover:scale-105 transition-all"
                  >
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-700 dark:text-muted-foreground font-medium">1,200+ Successful Matches</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-5 w-5 text-green-500" />
                  <span className="text-slate-700 dark:text-muted-foreground font-medium">98% Satisfaction Rate</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-6">
                {sampleMatches.map((match, index) => (
                  <Card 
                    key={match.id}
                    className={`group hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary/50 dark:hover:border-purple-500 hover:-translate-y-2 ${
                      index % 2 === 1 ? 'mt-8' : ''
                    }`}
                  >
                    <CardContent className="p-6">
                      ...
                      <div className="mt-4 text-center">
                        <span className="text-green-600 dark: text-success font-bold text-sm">
                          {match.match}% Match
                        </span>
                      </div>
                    </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-lg mb-2 text-slate-900 dark:text-primary-foreground">
                    Student-to-Student Only 🎓
                  </h4>
                  <p className="text-slate-700 dark:text-muted-foreground mb-3">
                  ...
                  <div className="grid md:grid-cols-2 gap-3 text-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-slate-600 dark:text-slate-400">
                        <span className="font-semibold text-slate-700 dark:text-muted-foreground">Authentic matches:</span> Connect with real students
                      </span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-slate-600 dark:text-slate-400">
                        <span className="font-semibold text-slate-700 dark:text-muted-foreground">Your space:</span> One person rents, then sublets
                      </span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-slate-600 dark:text-slate-400">
                        <span className="font-semibold text-slate-700 dark:text-muted-foreground">Safe & private:</span> No commercial interference
                      </span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-slate-600 dark:text-slate-400">
                        <span className="font-semibold text-slate-700 dark:text-muted-foreground">Verified students:</span> Student ID required
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-2 border-purple-200 dark:border-purple-800">
              <CardContent className="p-6">
                ...
                <p className="text-slate-700 dark:text-muted-foreground mb-4 italic">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/roommate/browse">
              <Button 
                size="lg"
                variant="outline"
                className="border-2 border-white text-primary-foreground hover:bg-white/10 font-bold text-xl px-10 py-7 rounded-2xl backdrop-blur-sm"
              >
